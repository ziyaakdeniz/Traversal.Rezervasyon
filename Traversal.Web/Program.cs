...
builder.Services.AddIdentity<AppUser, AppRole>().AddEntityFrameworkStores<ApplicationDbContext>().AddErrorDescriber<CustumIdentityValidator>().AddEntityFrameworkStores<ApplicationDbContext>();
